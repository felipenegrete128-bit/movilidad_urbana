...
**Contexto & objetivo:**  
- México y Sao Paulo muestran mayores retrasos y también un PIB per cápita elevado, sin embargo, al ver el caso de Montevideo con un alto PIB pero baja incidencia en retrasos podemos inferir que la congestión no determina automáticamente la productividad; otros factores median esta relación. 
